                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="col-lg-12">
                                <?php 
                                echo $this->Html->link('Add', array('controller' => 'packages','action' => 'add_package','full_base' => true,$uid),array('class'=>'btn btn-primary btn-flat header-btn'));
                                ...
                                <table id="userGrid" class="display responsive nowrap" cellspacing="0" width="100%">
                                  ...
                                  <tr class="filter" width="100%">
                                    ...
                                    <td> <input class="search_init" type="text" value="" placeholder="Duration" name="duration"> </td>
...
$(document).ready(function() {
    table = $('#userGrid').DataTable( {
        ...
        //"filter":false,        
        "ajax": '<?php echo $this->Html->url(array("controller" => "packages","action" => "admin_index_data","full_base"=>TRUE,$uid));?>',
        "columns": [
                        { "name": "Package.id", "orderable":false,"searchable":false,'width':'7%', 'sClass': 'text-center'},
                        { "name": "Package.title", 'width':'15%'},
                        { "name": "Package.duration", 'width':'13%'},
                        { "name": "Package.price", 'width':'17%'},
