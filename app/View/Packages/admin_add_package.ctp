                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-lg-10">
                                  <?php  echo $this->Form->create('Package',array('class'=>'form-horizontal style-form','enctype'=>'multipart/form-data','validate'));?>
                                    
                                            <?php echo $this->Form->hidden('id'); echo $this->Form->hidden('user_id');?>
                                            <div class="form-group">
                                                <?php echo $this->Form->label('Title',null,array('class'=>'col-md-3 control-label'));?>
                                                <div class="col-md-7">
                                                    <?php echo $this->Form->input('title',array('class'=>'form-control','label'=>false,'div'=>false));?>
                                                </div>    
                                            </div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <?php echo $this->Form->label('Duration',null,array('class'=>'col-md-3 control-label'));?>
                                                <div class="col-md-7">
                                                    <?php echo $this->Form->input('duration',array('options'=>$timeOptions,'class'=>'form-control','required'=>false,'label'=>false,'div'=>false));?>
                                                </div>    
                                            </div>
                      ...
                      <?php //echo $this->Form->label('',null,array('class'=>'col-md-3 control-label'));?>
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <?php
                                                echo $this->Html->link('Cancel',array('controller'=>'packages','action'=>'index','full_base'=>true,$uId,$packageId),array('class'=>'btn btn-warning')
