                                ...
                                <div class="col-lg-10">
                                  <?php  echo $this->Form->create('User',array('class'=>'form-horizontal style-form','enctype'=>'multipart/form-data','validate'));?>
                                            ...
                                            <div class="form-group">
                                                <?php echo $this->Form->label('Full Name',null,array('class'=>'col-md-3 control-label'));?>
                                                <div class="col-md-7">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <?php echo $this->Form->input('password',array('type'=>'password','class'=>'form-control','required'=>isset($this->request->data['User']['id'])? false:true,'label'=>false,'div'=>false,'value'=>''));?>
                                                </div>    
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <?php echo $this->Form->label('State',null,array('class'=>'col-md-3 control-label'));?>
                                                <div class="col-md-7">
                                            ...
                                            <div class="form-group">
                                                <?php echo $this->Form->label('Country',null,array('class'=>'col-md-3 control-label'));?>
                                                <div class="col-md-7">
                                                    <?php echo $this->Form->input('country',array('options'=>$country,'class'=>'form-control','required'=>false,'label'=>false,'div'=>false,'disabled'=>isset($this->request->data['User']['id'])? false:false));?>
                                                </div>    
                                            </div>

                                            <div class="form-group">
                                                <?php echo $this->Form->label('Zip',null,array('class'=>'col-md-3 control-label'));?>
                                                <div class="col-md-7">
                                                    <?php echo $this->Form->input('zip',array('type'=>'number','class'=>'form-control','label'=>false,'div'=>false));?>
                                                </div>    
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <?php echo $this->Form->input('user_image',array('type'=>'file','class'=>'form-control','required'=>isset($this->request->data['User']['id'])? false:true,'label'=>false,'div'=>false));
                                                       echo  $this->Form->hidden('image');
                                                    ?>
                                                </div>    
                                                <div class="col-md-3">
                                                    <?php 
                                                    $img =isset( $this->request->data['User']['image'] ) ? $this->request->data['User']['image'] : "img_not_found.jpg";
